...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td>
									<input type="radio" name="sdsex" value="男">男
									<input type="radio" name="sdsex" value="女">女
								</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" name="sdhobby" id="sdhobby1" value="篮球">篮球
									<input type="checkbox" name="sdhobby" id="sdhobby2" value="足球">足球
									<input type="checkbox" name="sdhobby" id="sdhobby3" value="排球">排球
								</td>
 								<td>学生生日：</td>
   ...
   <script src="${path }/resources/js/plugins/layer/laydate/laydate.js"></script>
	  	...
	  	$("#btn_echarts").click(function(){
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	res.li.forEach(function(stu){
	    			    		ydata.push(stu.num);
	    			    		xdata.push(stu.mdname);
	    			    	})
	    			    	if(res.success){
	    			    		option = {
	    			    			    xAxis: {
	...
	function initEditUser(getSelection){
		...
		$('#mdname').val(getSelection.mdname);
	}
