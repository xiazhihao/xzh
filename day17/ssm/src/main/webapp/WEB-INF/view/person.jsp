...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" name="start" type="date"/>
                     <input placeholder="结束时间"id="txt_search_end" name="end" type="date"/>
                 </div>
	          </div>
		  	</div>
	...
	<div class="modal fade" id="modal_user_imp" role="dialog" aria-labelledby="modal_user_imp" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_imp" method="post" action="impPerson.htm" enctype="multipart/form-data">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学员姓名：</td>
