...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_dId" id = "txt_search_dId">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm" enctype="MultipartFile/form-data">
						<input type="hidden" name="eId" id="hidden_txt_eId" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<input type="radio" id="gender" name="gender" value="女" aria-required="true" required/>女
								</td>
							</tr>
								<tr>
								<td>年龄：</td>
							...
							<tr>
								<td>爱好：</td>
								<td>
								<input type="checkbox" id="hobby1" name="hobby" value="篮球" aria-required="true" required/>篮球
								<input type="checkbox" id="hobby2" name="hobby" value="足球" aria-required="true" required/>足球
								<input type="checkbox" id="hobby3" name="hobby" value="排球" aria-required="true" required/>排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>头像：</td>
								<td>
								<img alt="" id="pics" src="" width="50px" height="50px">
								<input type="file" id="picFile" name="picFile"  required/ width="50px" height="50px">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_eId").value='';
	...
	function initEditUser(getSelection){
		$('#hidden_txt_eId').val(getSelection.eId);
		...
		$('#pics').attr('src',"/pic/"+getSelection.pic)
