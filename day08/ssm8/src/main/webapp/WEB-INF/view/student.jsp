...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="scid" id = "txt_search_scid">
						<option value="0">---请选择---</option>
						<c:forEach items="${roleList }" var="r">
							<option value="${r.scid }">${r.scname }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
							...
							<tr>
								...
								<td>
									...
									<input type="radio" id="sex" name="sex" value="女"
										 aria-required="true" required/>女
								</td>
							</tr>
							<tr>
								<td>学生名称：</td>
								<td>
									<select class="form-control" name="scid" id = "scid" aria-required="true" required>
	...
	function initEditUser(getSelection){
		...
		$('#scname').val(getSelection.scname);
	}
