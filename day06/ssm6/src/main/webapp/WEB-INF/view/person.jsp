...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input  id="txt_search_start" name="start" type="date"/>
                     <input id="txt_search_end" name="end" type="date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td>
									<input type="checkbox" name="expressTrait" id="expressTrait1" value="耐性">耐性
									<input type="checkbox" name="expressTrait" id="expressTrait2" value="干练">干练
									<input type="checkbox" name="expressTrait" id="expressTrait3" value="效率">效率
								</td>
								<td>入职时间：</td>
								<td>
									<input type="date" name="entryTime" id="entryTime">
								</td>
							</tr>
							<tr>
								<td>公司：</td>
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait1').prop("checked",getSelection.expressTrait.indexOf("干练")!=-1)
		$('#expressTrait1').prop("checked",getSelection.expressTrait.indexOf("效率")!=-1)
