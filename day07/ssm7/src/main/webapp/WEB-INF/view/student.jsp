...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="MultipartFile/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生头像：</td>
								<td>
									<img alt="" id="pics" src="" width="30px" height="30px">
	...
	<!-- <!--echatrs对话框 -->
	<div class="modal fade" id="modal_user_bing" role="dialog" aria-labelledby="modal_user_bing" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-body" >
					<div style="width: 500px;height: 500px" id="bingtu"></div>
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
    ...
    <script src="${path }/resources/jsecharts.js"></script>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_bing").click(function() {
				$('#modal_user_bing').modal({backdrop : 'static',keyboard : false});
