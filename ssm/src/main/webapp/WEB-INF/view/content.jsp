...
<body class="gray-bg">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_contentcategoryid" id = "txt_search_contentcategoryid">
						...
						<c:forEach items="${goryList }" var="g">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						<input type="hidden" name="contentid" id="hidden_txt_contentid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<tr>
								<td>图片：</td>
								<td><input type="text" name="picpath" id="picpath"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form action="importContent.htm" id="form_import" method="post" enctype="multipart/form-data">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_contentid").value='';
	...
	function initEditUser(getSelection){
		$('#hidden_txt_contentid').val(getSelection.contentid);
